...
_A plain-language overview of where the Directorium API is headed. Each version links to its tracking
...
## ✅ Code-complete on `develop` — [v0.1.0](https://github.com/Directorium/Api/milestone/1)
**The platform comes online.** A versioned `/v1` service over Core (`directorium/core`, no liturgical logic
...
## 🗓️ Next — [v0.2.0](https://github.com/Directorium/Api/milestone/3)
...
## 🔭 Future
- **[v0.3.0](https://github.com/Directorium/Api/milestone/4) — Outputs & integrations.** iCal feed +
  printable monthly Ordo (PDF).
- **[v0.4.0](https://github.com/Directorium/Api/milestone/2) — 1954/1955 rubric-system parameters.**
  Endpoints for the 1954 and 1955 rubric systems as Core gains them.
- **[v1.0.0](https://github.com/Directorium/Api/milestone/5) — Platform launch.** Cut together with
  Core, Site, and Ordo — **OpenAPI**, generated **JS/PHP/Python SDKs**, a **docs portal**, and a
  versioning policy.
- **[v1.1.0](https://github.com/Directorium/Api/milestone/6) — Text infrastructure over the API.** The
...
- **[v1.2.0](https://github.com/Directorium/Api/milestone/7) — Mass/Missal API.** Ordinary + Proper,
  plus the **lectionary endpoint**.
- **[v1.3.0](https://github.com/Directorium/Api/milestone/8) — Breviary/Office API.** Canonical hours,
  psalter, propers.
- **[v1.4.0](https://github.com/Directorium/Api/milestone/10) — Novus Ordo & LOTH delivery.**
  `/v1/editions` discovery with **capability + textAvailability flags**, LOTH hour params, and NO
  lectionary cycle params.
- **[v2.0.0](https://github.com/Directorium/Api/milestone/9) — Comparison endpoints.**
  `/v1/compare/calendar`, `/compare/rite`, `/compare/office` over the shared diff engine, plus
  `/v1/rites` discovery.
- **[v2.1.0](https://github.com/Directorium/Api/milestone/11) — Supporting-corpora API.** Martyrology,
